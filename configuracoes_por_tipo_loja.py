...
def criar_configuracoes_especificas():
    """
    Cria configurações específicas por tipo de loja
    """
    print("🔧 Criando configurações específicas por tipo de loja...")
    
    models_path = 'lojas/models_configuracoes_especificas.py'
...
'''
    ...
    try:
        ...
        print("✅ Configurações específicas por tipo de loja criadas")
        return True
    except Exception as e:
        print(f"❌ Erro ao criar configurações específicas: {e}")
        return False
...
def main():
    ...
    # 1. Criar configurações específicas
    if criar_configuracoes_especificas():
        success_count += 1
    ...
    if success_count == total_tasks:
        print("🎉 CONFIGURAÇÕES ESPECÍFICAS CRIADAS COM SUCESSO!")
        print("📋 TIPOS DE LOJA CONTEMPLADOS:")
        print("- 🍔 Lanchonetes/Restaurantes")
        print("- 💅 Clínicas de Estética")
        print("- 👕 Lojas de Roupas")
        print("- 🛒 Supermercados")
    else:
